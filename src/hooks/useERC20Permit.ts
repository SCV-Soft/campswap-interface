...
import { DAI, CAMP, USDC } from '../constants/tokens'
...
const PERMITTABLE_TOKENS: {
  ...
  [1]: {
    ...
    [CAMP[1].address]: { type: PermitType.AMOUNT, name: 'CampSwap' },
  },
  [4]: {
    ...
    [CAMP[4].address]: { type: PermitType.AMOUNT, name: 'CampSwap' },
  },
  [3]: {
    [CAMP[3].address]: { type: PermitType.AMOUNT, name: 'CampSwap' },
  ...
  [5]: {
    [CAMP[5].address]: { type: PermitType.AMOUNT, name: 'CampSwap' },
  },
  [42]: {
    [CAMP[42].address]: { type: PermitType.AMOUNT, name: 'CampSwap' },
  },
}
