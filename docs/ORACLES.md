...
Currently there is two types of oracles which the camp interface supports, Chainlink & CampSwap TWAP.
...
Each price feed has a pair token0/token1, CAMP/ETH or CAMP/USD for example, decimals, and proxy. We use this information to construct mappings of the price feed to their respectful pair tokens.
